<h2><a href="https://leetcode.com/problems/encode-string-with-shortest-length">471. Encode String with Shortest Length</a></h2><h3>Hard</h3><hr><p>Given a string <code>s</code>, encode the string such that its encoded length is the shortest.</p>
